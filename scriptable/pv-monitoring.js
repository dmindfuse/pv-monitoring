...
vStack1.addSpacer();
addDataView(vStack1, data.exportPower.toString() + "W", defineColorNegative(100, -100, data.exportPower), "Netz", defineFootnote(50, -50, "Bezug", "Einspeisen", "Speicherregelung", data.exportPower));
vStack1.addSpacer();
